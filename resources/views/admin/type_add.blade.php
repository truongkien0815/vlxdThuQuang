          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" required name="type_name" id="inputName" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="inputStatus">Danh mục lớn</label>
                <select id="inputStatus" name="pid" class="form-control custom-select">
                  <!-- <option disabled>Select one</option> -->
                  <option>0</option>
                  @foreach($protype as $itam)
                  <option selected value="{{ $itam->protype_id}}">{{ $itam->name}}</option>
             @endforeach
                </select>
              </div>
          ...
          <div class="card card-secondary">
            <div class="card-header">
              ...
              <!-- <div class="form-group">
                ...
                <input type="text" required name="vn_title_site" id="inputName" class="form-control" >
              </div> -->
            
            <div class="card-body">
            <div class="form-group">
                <label for="inputName">options</label>
                <input type="text" required name="options" id="inputName" class="form-control" >
              </div>
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="inputEstimatedBudget">Hình ảnh sản phẩm</label>
